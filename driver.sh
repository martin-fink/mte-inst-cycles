...
for f in ./*-baseline; do
  ...
  baseline_output=$(../simpleperf stat -e cpu-cycles,raw-op-retired,instructions "./$benchmark-baseline")
  ...
  lat_output=$(../simpleperf stat -e cpu-cycles,raw-op-retired,instructions "./$benchmark-latency")
  ...
  tp_output=$(../simpleperf stat -e cpu-cycles,instructions "./$benchmark-throughput")
